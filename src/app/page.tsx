    ...
    <div>
      ...
      <section className="py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold text-white">{content.cta.text}</h2>
          <div className="mt-8">
            <Link
              href="/order"
              className="inline-flex items-center bg-[#ffe03b] text-black font-bold rounded-full hover:bg-yellow-300 transition-colors"
